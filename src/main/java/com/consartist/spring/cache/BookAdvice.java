...
public class BookAdvice {
  ...
  public static class BookTagger {
    ...
    @SneakyThrows
    public BookTagger tag(@NonNull String tagMethodName, Object tagValue,
      ...
      maybeBook = maybeBook == null
          ...
          (maybeBook.getClass().getClassLoader() != null
              ...
              maybeBook.getClass().getClassLoader().loadClass(Book.class.getName())
                  .isInstance(maybeBook))
              ? tagValue != null
                  ? invokeMethod(maybeBook, tagMethodName, tagValue) :
                  invokeMethod(maybeBook, tagMethodName, new Object[] {null},
